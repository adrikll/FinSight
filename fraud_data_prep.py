...
def fetch_bcb_pix_ecosystem():
    ...
    if len(df_trans) > MAX_AMOSTRA:
        print(f"⚙️ Aplicando amostragem estratificada proporcional para limitar a {MAX_AMOSTRA} registros...")
    ...
    print(f"✅ Dados otimizados salvos com sucesso ({len(df_trans)} registros de transações e {len(df_fraud)} de fraudes).")
